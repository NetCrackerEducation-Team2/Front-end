      ...
      this.navLinks = [
        {
          ...
          link: '/search-users',
          index: 8,
          access: state.accessMap.get('admin') ||
            state.accessMap.get('superadmin') ||
            state.accessMap.get('user') ||
            state.accessMap.get('moderatorForReviews') ||
            state.accessMap.get('moderatorForBooks') ||
            state.accessMap.get('moderatorForAnnouncements')
        }
      ];
