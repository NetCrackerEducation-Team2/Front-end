...
export const environment = {
  ...
  API_BOOK_REVIEW: 'https://localhost:8081/api/book-review',
  ...
  API_BOOK: 'https://netcracker2-back-end.herokuapp.com/api/book',
  API_BOOK_OVERVIEWS: 'https://netcracker2-back-end.herokuapp.com/api/book-overviews',
  API_BOOK_REVIEW: 'https://netcracker2-back-end.herokuapp.com/api/book-review',
